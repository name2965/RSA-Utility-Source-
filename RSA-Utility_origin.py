...
class Utils:
    ...
    def Key_create_window_sep(var,button1,label2,bit):
        if bit == '':
            ...
            button1.config(text='Create number key',command = lambda : Utils.create_private_public_key(int(bit),label2))

        elif var.get() == 2:
            button1.config(text='Create pem file',command = lambda : Utils.create_private_public_pem(int(bit),label2))
...
class Windows:
    def extract_key_window():
        ...
        button1 = Button(instance_window,text='Browse...',command = lambda : Utils.extract_key(label2))
    ...
    def data_encrypt_number_window():
        ...
        button1 = Button(instance_window,text='encrypt data', command = lambda : Utils.encrypt(plain_data.get(),e.get(),n.get(),label4))
    ...
    def data_encrypt_pem_window():
        ...
        button1 = Button(instance_window,text='encrypt data', command = lambda : Utils.encrypt_pem(plain_data.get(),file_path.get(),label3))
        button2 = Button(instance_window,text='Browse...',command = lambda : Utils.open_pem(textbox2))
        label1.grid(column=0,row=0)
        textbox1.grid(column=1,row=0)
        label2.grid(column=0,row=1)
        textbox2.grid(column=1,row=1)
    ...
    def convert_string_to_bytes_window():
        ...
        button1 = Button(instance_window,text='Convert', command = lambda : Utils.convert_string_to_bytes(plain_string.get(),label2))
        label1.grid(column=0,row=0)
        textbox1.grid(column=1,row=0)
    ...
    def data_decrypt_number_window():
        ...
        button1 = Button(instance_window,text='decrypt data', command = lambda : Utils.decrypt(enc_data.get(),d.get(),n.get(),label4))
        label1.grid(column=0,row=0)
        textbox1.grid(column=1,row=0)
        label2.grid(column=0,row=1)
        textbox2.grid(column=1,row=1)
    ...
    def data_decrypt_pem_window():
        ...
        textbox1 = Entry(instance_window,width=30,textvariable=plain_data)
        textbox2 = Entry(instance_window,width=30,textvariable=file_path)
        button1 = Button(instance_window,text='decrypt data', command = lambda : Utils.decrypt_pem(plain_data.get(),file_path.get(),label3))
        button2 = Button(instance_window,text='Browse...',command = lambda : Utils.open_pem(textbox2))
        label1.grid(column=0,row=0)
        textbox1.grid(column=1,row=0)
        label2.grid(column=0,row=1)
    ...
    def convert_bytes_to_string_window():
        ...
        button1 = Button(instance_window,text='Convert', command = lambda : Utils.convert_bytes_to_string(plain_bytes.get(),label2))
        label1.grid(column=0,row=0)
        textbox1.grid(column=1,row=0)
        label2.grid(column=1,row=1)
        button1.grid(column=1,row=3)
    ...
    def Key_create_window():
        ...
        pem_rb = Radiobutton(instance_window,text='.pem key', variable=var, value=2,command = lambda : Utils.Key_create_window_sep(var,button1,label2,combo.get()))
        num_rb = Radiobutton(instance_window,text='number key',variable=var, value=1,command = lambda : Utils.Key_create_window_sep(var,button1,label2,combo.get()))
...
if __name__ == '__main__':
    ...
    label1 = Label(window, text="github : https://github.com/name2965/RSA-Utility")
    label.pack(expand=1)
    ...
    menu1.add_command(label ='Private/Public key', command = Windows.Key_create_window)
    allMenu.add_cascade(label='Create key',menu=menu1)

    menu2 = Menu(allMenu,tearoff=0)
    menu2.add_radiobutton(label='From .pem file', command = Windows.extract_key_window)
    allMenu.add_cascade(label='Extract key',menu=menu2)

    menu3 = Menu(allMenu, tearoff=0)
    menu3.add_radiobutton(label='Encrypt data(number key)', command = Windows.data_encrypt_number_window)
    menu3.add_radiobutton(label='Encrypt data(pem key)', command = Windows.data_encrypt_pem_window)
    menu3.add_radiobutton(label='Convert string to bytes', command = Windows.convert_string_to_bytes_window)
    allMenu.add_cascade(label='Encrypt',menu=menu3)

    menu4 = Menu(allMenu, tearoff=0)
    menu4.add_radiobutton(label='Decrypt data(number key)', command = Windows.data_decrypt_number_window)
    menu4.add_radiobutton(label='Decrypt data(pem key)', command = Windows.data_decrypt_pem_window)
    menu4.add_radiobutton(label='Convert bytes to string', command = Windows.convert_bytes_to_string_window)
